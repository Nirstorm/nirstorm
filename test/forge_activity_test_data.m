...
for ichan=1:length(ChannelMat.Channel)
    ChannelMat.Channel(ichan).Name = strrep(ChannelMat.Channel(ichan).Name, ...
                                            'WL690', 'HbO');
    ChannelMat.Channel(ichan).Name = strrep(ChannelMat.Channel(ichan).Name, ...
                                            'WL830', 'HbR');
    ChannelMat.Channel(ichan).Group = strrep(ChannelMat.Channel(ichan).Group, ...
                                            'WL690', 'HbO');   
    ChannelMat.Channel(ichan).Group = strrep(ChannelMat.Channel(ichan).Group, ...
                                            'WL830', 'HbR');                                    
end
...
nst_bst_add_surf_data(pdata_hbr, sData.Time, ...
