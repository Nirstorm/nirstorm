...
row_prefixes = cellfun(@strtrim, nst_strsplit(sProcess.options.row_prefixes.Value, ','),...
                       'UniformOutput', 0);

col_prefixes = cellfun(@strtrim, nst_strsplit(sProcess.options.col_prefixes.Value, ','),...
                       'UniformOutput', 0);                       
